...
Manage Plane projects without leaving Obsidian: sync modules and work items, create and edit issues, view them in a Kanban board, and generate linked notes that push changes back to Plane when you want.
